...
namespace ito::details::utils
{
    ...
    public:
        ...
        [[nodiscard]] T&       get() { return m_object; }
        [[nodiscard]] const T& get() const { return m_object; }
        [[nodiscard]] T*       operator->() { return &m_object; }
        [[nodiscard]] const T* operator->() const { return &m_object; }
